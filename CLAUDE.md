...
там экраны, формат данных, механики, дизайн-токены, правила кэша
(поднимать версию в sw.js при каждой правке!) и сложившийся процесс работы
с субагентами. Дизайн-док: [docs/design/design-doc.md](docs/design/design-doc.md).
Только светлая тема. Эталон дизайна — Яндекс Лавка.
